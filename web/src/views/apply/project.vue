  ...
  <div class="app-container">
    <el-form :inline="true" class="demo-form-inline">
      <el-form-item label="项目标题">
        <el-input v-model="dataVo.title" placeholder="请输入项目标题"/>
      </el-form-item>
    ...
    >
      ...
      <el-table-column label="操作" align="center" width="300">
        <template slot-scope="scope">
          <el-button type="primary" size="mini" icon="el-icon-edit" v-if="scope.row.status === '0'" @click="updateAndSave(scope.row)">审核项目</el-button>
...
<script>
import { deleteById, pageQuery, audit, getWord} from '@/api/project'
    ...
    downloadFile(fileUrl) {
      if(fileUrl == '' || fileUrl == null){
        ...
        getWord(fileUrl).then(res=>{
          ...
          const fileName = "项目资料"+new Date().getTime()+".docx";
