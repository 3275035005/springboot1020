  ...
  <div class="app-container">
    <el-form :inline="true" class="demo-form-inline">
      <el-form-item label="政策标题">
        <el-input v-model="dataVo.title" placeholder="请输入政策标题"/>
      </el-form-item>
    ...
    <el-table
      ...
      empty-text="暂无数据"
    >
<!--      <el-table-column align="center" label="政策封面">-->
...
<!--      </el-table-column>-->
      ...
      <el-table-column align="content" label="政策内容">
        <template slot-scope="scope">
    ...
    >
      <el-form :model="formData" label-position="left" label-width="120px">
        <el-form-item label="政策标题">
          <el-input v-model="formData.title"   placeholder="请填写政策标题"/>
        </el-form-item>
...
<!--            accept="image/*"-->
<!--            class="productPicture-uploader"-->
<!--          >-->
<!--            <img v-if="formData.image" :src="formData.image" class="productPicture">-->
<!--            <i v-else class="el-icon-plus productPicture-uploader-icon"></i>-->
<!--          </el-upload>-->
<!--        </el-form-item>-->
...
<script>
import { deleteById, update, insert, pageQuery} from '@/api/policy'
