<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="describes" label="轮播图介绍"/>
    ...
    >
      <el-form :model="formData" label-position="left" label-width="120px">
        <el-form-item label="轮播图介绍">
          <el-input v-model="formData.describes"  type="textarea"
                    :rows="2" placeholder="请填写轮播图介绍"/>
        </el-form-item>
        ...
        <el-form-item label="封面">
          ...
          >
            <img v-if="formData.imgPath" :src="formData.imgPath" class="productPicture">
...
<script>
import { deleteById, update, insert, pageQuery} from '@/api/carousel'
export default {
  data() { // 定义变量和初始值
    return {
